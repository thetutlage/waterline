...
module.exports = function(criteria, values, cb) {
  ...
  createBelongsTo.call(this, valuesObject, function(err) {
    ...
    beforeCallbacks.call(self,valuesObject.criteria.where.id,valuesObject.values, function(err) {
      if(err) return cb(err);
...
function beforeCallbacks(id,values, cb) {
  var self = this;
  async.series([
    ...
    function(cb) {
      callbacks.beforeUpdate(self,id,values, cb);
    }
